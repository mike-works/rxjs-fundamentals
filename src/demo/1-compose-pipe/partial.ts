...
export function partial<A, B, C, R>(fn: (a: A, b: B, c: C) => R, pa: A): (b: B, c: C) => R;
// 3-argument function, 2 arguments pre-applied
export function partial<A, B, C, R>(fn: (a: A, b: B, c: C) => R, pa: A, pb: B): (c: C) => R;
// 3-argument function, 3 arguments pre-applied
export function partial<A, B, C, R>(fn: (a: A, b: B, c: C) => R, pa: A, pb: B, pc: C): () => R;
...
export function partial<A, B, C, D, R>(fn: (a: A, b: B, c: C, d: D) => R, pa: A): (b: B, c: C, d: D) => R;
// 4-argument function, 2 arguments pre-applied
export function partial<A, B, C, D, R>(fn: (a: A, b: B, c: C, d: D) => R, pa: A, pb: B): (c: C, d: D) => R;
// 4-argument function, 3 arguments pre-applied
export function partial<A, B, C, D, R>(fn: (a: A, b: B, c: C, d: D) => R, pa: A, pb: B, pc: C): (d: D) => R;
// 4-argument function, 4 arguments pre-applied
export function partial<A, B, C, D, R>(fn: (a: A, b: B, c: C, d: D) => R, pa: A, pb: B, pc: C, pd: D): () => R;
